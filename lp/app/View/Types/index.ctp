<div class="types index">
	...
	<tr>
		...
		<td><?php echo h($op['type'][$type['Type']['kind']]); ?></td>
		<td><?php echo h($type['Type']['name']); ?>&nbsp;</td>
		<td><?php echo h($type['Type']['photo']); ?>&nbsp;</td>
		<td><?php echo h($type['Type']['others']); ?>&nbsp;</td>
		<td><?php echo h($type['Type']['detail']); ?>&nbsp;</td>
		<td><?php echo h($type['Type']['sort']); ?>&nbsp;</td>
