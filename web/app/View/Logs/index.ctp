<div class="logs index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('fish'); ?></th>
			<th><?php echo $this->Paginator->sort('bait_id'); ?></th>
			<th><?php echo $this->Paginator->sort('bait'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($log['Fish']['name']); ?>&nbsp;</td>
		<td><?php echo h($log['Log']['fish']); ?>&nbsp;</td>
		<td><?php echo h($log['Bait']['name']); ?>&nbsp;</td>
		<td><?php echo h($log['Log']['bait']); ?>&nbsp;</td>
		<td><?php echo h($op['public'][$log['Log']['status']]); ?>&nbsp;</td>
